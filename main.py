...
from interfaces import _001_front_menu, _002_main_menu, _003_select_product_menu, _004_purchase_menu
...
def main_program():
    while get_program_status():
        ...
        match (get_current_display()):
            ...
            case "Purchase Product Menu":
                _004_purchase_menu._self()
            case "Purchase Finalization Menu":
                pass
            case "Final Menu":
                pass
            case _:
